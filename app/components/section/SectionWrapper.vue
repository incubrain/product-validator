...
const wireframeUI = computed(() => {
  if (!props.wireframe) return {};
  ...
  return {
    ...
    headline: 'hidden', // We'll render it in title slot
    title: 'max-w-4xl mx-auto', // Custom slot overrides this
      ...
      <template #title>
        <div class="space-y-3">
          ...
          <div class="flex justify-center">
            <div
              class="h-1 w-20 bg-gradient-to-r from-transparent via-success to-transparent"
            />
          </div>
        </div>
      </template>
