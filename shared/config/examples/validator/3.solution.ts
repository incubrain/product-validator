...
import type { Affiliations, Alternative, Outcome } from '#types';
...
export const alternatives = [
  ...
  },
  {
    ...
    why_fails:
      "Flashy design focus which doesn't matter untill you are scaling an already profitable buisniess",
